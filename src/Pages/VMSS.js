...
class VMSS extends React.Component {
    render() {
        return (
            <Aux>
            <Row>
                        ...
                        <Card.Body>
                            <div className="row d-flex align-items-center">
                                <div className="col-10">
                                    <h3 className="f-w-400 d-flex align-items-center text-center m-b-0">Virtual Machines Scale Set</h3>
                ...
                <Col md={6} xl={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Create Virtual Machine Scale Set</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            ...
                            <Row>
                                    ...
                                    <Form>
                                        <Form.Group controlId="formBasic">
                                            ...
                                            <Form.Text className="text-muted">
                                                Please enter the Subscription you want the VMSS to be in. 
                                            </Form.Text>
                                        </Form.Group>
                                        ...
                                        <Form.Group controlId="formBasic">
                                            <Form.Label>Virtual Machine Scale Set Name</Form.Label>
                                            <Form.Control type="email" placeholder="Enter VMSS Name" />
    
                                        </Form.Group>
                                        <Form.Group controlId="formBasic">
                                            <Form.Label>Number of Instances</Form.Label>
                                            <Form.Control type="email" placeholder="Enter number of Instances to be created." />
    
                                        </Form.Group>

                                        <Form.Group controlId="formBasic">
                                            <Form.Label>VMSS Instance Size</Form.Label>
                                            <Form.Control type="email" placeholder="Enter VMSS Size" />
                                            <Form.Text className="text-muted">
                                                Please enter the Size for Virtual Machines Scale Set Instances.
                                            </Form.Text>
                                        </Form.Group>
                                ...
                                <Col md={6}>
                                    <Form.Group controlId="formBasic">
                                            ...
                                            <Form.Text className="text-muted">
                                                Please enter the Resource Group you want the VMSS to be in. 
                                            </Form.Text>
                                    </Form.Group>
                                    <Form.Group>
                                        <Form.Check

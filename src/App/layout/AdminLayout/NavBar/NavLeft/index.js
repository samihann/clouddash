                ...
                <ul className="navbar-nav mr-auto">
                    <li className={navItemClass.join(' ')}>
                        <Dropdown alignRight={dropdownRightAlign}>
                            ...
                            <ul>
                                <Dropdown.Menu>
                                    <li><a className="dropdown-item" href="https://portal.azure.com/">Open Azure Portal</a></li>
                                    <li><a className="dropdown-item" href={DEMO.BLANK_LINK}>Re-fetch the cloud data</a></li>
                                </Dropdown.Menu>
                            </ul>
                        </Dropdown>
                    </li>
